...
#Topological Sorting means sorting/linear ordering of all the vertices of graph in such a format that 
...
#step2-traverse through the above array the elements which have their indegree = 0, append them to a queue
#step3- pop from the queue and add them to the output and also decrease the indegrees of all its adjacent nodes by 1
#step4- Now after decreasing the indegrees by 1 check if some node's indegree has become 0 or not,
