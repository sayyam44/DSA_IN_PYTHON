#verryy importan , read all methods carefully
...
#optimal 1- using hash map, tc=m+n,
# use hash map/set and put all values of 1st head in hash map and then iterate through the 2nd head and check if this value is already present in the hash map 
